    ...
    <>
      ...
      <nav
        className="
            navbar
            container 
            p-[1rem_2rem] sm:p-[1.2rem_2rem] md:p-[1.5rem_3rem] lg:p-[1.6rem_2.8rem]  xl:p-[1.3rem_14rem] 2xl:p-[2rem_0]
        ...
        >
          <NavLink to="/">
            ...
            <div className="flex items-center md:gap-[0.3rem] leading-none">
              <span className="font-bold">foodie</span> <IoFastFoodSharp />
            </div>
          </NavLink>
        </div>
        <div
        ...
        >
          <ul
            className="
              navList
              flex
              gap-[3rem] sm:gap-[5rem] md:gap-[1.7rem] lg:gap-[2.5rem]
