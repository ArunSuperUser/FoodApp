...
const SignUp = ({ setShowLogin }) => {
  ...
  return (
    <main className="flex items-center justify-center absolute w-full h-full z-1 bg-[#00000090]">
      <div
        className="
                  auth-logIn-signIn
                  bg-amber-50
                  p-[3rem_2.5rem] sm:p-[3.2rem_3.1rem] md:p-[4rem_3.7rem]  lg:p-[5.5rem_4rem]
                  w-[30rem] sm:w-[32rem] md:w-[37rem] lg:w-[40rem]
                  h-[30rem] sm:h-[36rem] md:h-[44rem] lg:h-[50rem]
