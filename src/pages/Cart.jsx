...
const Cart = () => {
  ...
  return (
    <div className="container containerL px-[2rem] xl:px-[14rem] 2xl:px-0 relative">
      <div className="pt-4 sm:pt-7 md:pt-10 lg:pt-13 xl:pt-16">
        <hr />
        <ul
          className="
                grid
      ...
      <div
        className="
                ...
                grid 
                md:grid-cols-2
                gap-[1.8rem] sm:gap-[3rem] md:gap-[12rem] lg:gap-[20rem]
                my-[7rem] lg:my-[10rem]
                px-[6rem] md:px-0
                "
      >
          ...
          >
            <div
              className="
                      ...
                      text-[1rem] sm:text-[1.2rem] lg:text-[1.7rem] 2xl:text-[2rem]
                      border-zinc-400
                      "
            >
              <p>Subtotal</p>
